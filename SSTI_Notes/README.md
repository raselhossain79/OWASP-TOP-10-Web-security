...
| `06_SSTI_WAF_Filter_Bypass.md` | WAF/filter detection logic and bypass techniques — encoding, obfuscation, polyglot variation |
| `07_tplmap_Automation.md` | `tplmap` — the SSTI-equivalent of `sqlmap` — install, flags, output interpretation |
| `08_SSTI_Cheatsheet_and_Lab_Mapping.md` | Fast-lookup payload tables + full PortSwigger Academy lab progression |
...
5. Read `06` once you have working payloads — it covers how WAFs detect SSTI patterns and how to vary
   your payloads to evade signature-based detection without changing what they actually do.
6. Use `07` when you want to automate confirmation/exploitation, and understand what the tool is doing
   under the hood rather than trusting it blindly.
7. Use `08` as your live reference during labs, CTFs, or real engagements.
...
The full progression table lives in `08_SSTI_Cheatsheet_and_Lab_Mapping.md`.
