...
| 5 | [05_XXEinjector_Automation_Tool.md](05_XXEinjector_Automation_Tool.md) | XXEinjector — full flag reference, automation workflow, what it can't replace |
| 6 | [06_Cheatsheet_and_Lab_Mapping.md](06_Cheatsheet_and_Lab_Mapping.md) | Quick-reference payload cheatsheet + complete PortSwigger XXE lab mapping in Academy order |

## Recommended Reading Order

Read files 1 → 6 in sequence. Each file assumes the concepts from the previous one are
already understood. File 6 is meant to be kept open as a working reference during labs
or engagements.
