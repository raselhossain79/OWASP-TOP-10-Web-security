...
File 5 covers XXEinjector, the closest tool ecosystem has to a dedicated XXE
automation framework — what it can drive through automatically (the entity-chain
boilerplate from files 2–4) and what still requires the manual understanding built up
in this series.
